...
def clean_data(input1, input2):
    ...
    merged_data = merged_data[~merged_data['job'].str.contains('insurance|Insurance', case=False)]
...
if __name__ == '__main__':
    ...
    # Step 4: Print the shape of the output file
    print(f"The shape of the output data is: {cleaned_data.shape}")
